    ...
    static config: IPluginConfig = {
        ...
        */
        customerSettingsPage: {
            id: "OKACustomerSettings",
            title: "OKA customer settings page",
            type: "OKAcs",
            enabled: true,
            defaultSettings: {
                myServerSetting: "default value for setting defined in Interfaces.ts",
            },
            settingName: "OKA_settings",
        ...
        */
        field: {
            enabled: true,
            fieldType: "ui_plugin_oops_kibana_shortcut",
            title: "ui_plugin_oops_kibana_shortcut-field",
            fieldConfigOptions: {
                id: "ui_plugin_oops_kibana_shortcut",
                capabilities: {
                ...
                class: "",
                help: "",
                label: "ui_plugin_oops_kibana_shortcut-field",
            }
        },
